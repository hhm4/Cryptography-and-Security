...
plaintext3=int(raw_input("Enter plain text 3: "));
x=encrypt(pub,plaintext1)
y=encrypt(pub,plaintext2)
w=encrypt(pub,plaintext3)
print "\nCipherText"
print "----------------"
print "CipherText 1: ",x
print "CipherText 2: ",y
print "CipherText 3: ",w
z=e_add(pub,x,y,w)
decryptedtext=decrypt(priv,pub,z)
print "\nAfter Addition"
print "--------------"
print "CipherText 4 : ",z
print "PlainText 4 : ",decryptedtext
